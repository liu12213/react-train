...
export default class Popular extends Component {
    ...
    render() {
        ...
        // css样式变量style
        const style = {
            div1: { display: 'flex', flexDirection: 'row', justifyContent: 'space-around',flexWrap: 'nowrap', maxWidth: '1200px', margin: '0 auto', padding: '10px', fontSize: '18px', fontWeight: 'bold' },
            div2: { display: 'flex', flexDirection: 'row', justifyContent: 'space-around', flexWrap: 'wrap', maxWidth: '1200px', margin: '0 auto', fontSize: '18px', fontWeight: 'bold' },
            ul1: { listStyle: 'none', padding: '0 0 10px 0', width: '250px', margin: '10px', textAlign: 'center', background: 'rgba(0, 0, 0, 0.08)' },
            h4: { margin: '15px', fontSize: '30px', fontWeight: '400' },
            img: { width: '150px', height: '150px', margin: '0 0 10px 0' },
            li1: { lineHeight: '50px',fontWeight:'500'},
            li2: { lineHeight: '35px', textAlign: 'left', marginLeft: '30px',fontWeight:'400'},
